...
<head>
  ...
  <style>
    ...
    *,:before,:after{ box-sizing:border-box; }
    ...
    .summary-card{background:#fff;border:1px solid var(--gold-border);border-radius:20px;padding:18px 20px;}
    ...
    .btn-gold{display:inline-flex;align-items:center;gap:8px;height:42px;background:#ffd54f;border:1px solid rgba(0,0,0,.06);border-radius:12px;padding:0 14px;font-weight:700;color:#111;text-decoration:none;}
    .btn-gold:hover{filter:brightness(.97);color:#111;text-decoration:none;}

    /* Custom select */
    .select-custom{position:relative;display:inline-block;}
    .select-toggle{
      width:200px;height:42px;display:flex;align-items:center;justify-content:space-between;
    ...
    @media (max-width: 991.98px){
      ...
      .row-finance-main{display:block;margin-top:.6rem;}
      .row-finance-main > div{width:100% !important;margin-bottom:1rem;}
...
new Chart(document.getElementById('statusDonut'),{
  ...
  data:{
    ...
    datasets:[{
      data:dOrders,
      backgroundColor:['#94a3b8','#f59e0b','#22c55e','#3b82f6','#ef4444'],
      borderWidth:0
    }]
  },
  options:{
