        ...
        <ul class="nav flex-column mt-1" id="mobileNavList">
          ...
          <li class="nav-item">
            <a class="nav-link" href="faq.php">
              <span class="iconify" data-icon="mdi:help-circle-outline" data-width="22" data-height="22"></span>
              FAQ
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="history.php">
              <span class="iconify" data-icon="mdi:receipt-text-outline" data-width="22" data-height="22"></span>
              Riwayat pesanan
            </a>
          </li>
          <li><hr /></li>
