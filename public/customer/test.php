...
<html lang="id">
  <head>
    ...
    <!-- Preload hero untuk cegah kedip -->
    <link rel="preload" as="image" href="/public/assets/img/hero.jpg" />
    ...
    <style>
      ...
      html, body{
        ...
        overflow-x: hidden;
        -webkit-tap-highlight-color: transparent; /* hilangkan highlight mobile */
      }
      ...
      .icon-btn{
        background:transparent; border:0; padding:0; margin:0; line-height:1;
      ...
      .icon-btn:hover,.icon-btn:focus,.icon-btn:active{
        transform:none !important; transition:none !important; box-shadow:none !important; outline:none !important;
      }

      #cartBtn{
        border:none !important; background:transparent !important; border-radius:0 !important; padding:0 !important;
        text-decoration:none !important; color:var(--brown) !important; box-shadow:none !important; outline:none !important;
      }
      #cartBtn,#cartBtn:hover,#cartBtn:focus,#cartBtn:active{
        position:relative !important; top:0 !important; transform:none !important; transition:none !important;
        box-shadow:none !important; outline:none !important; color:var(--brown) !important; background:transparent !important; border:0 !important;
      }
      #cartBtn .iconify,#cartBtn .iconify:hover,#cartBtn .iconify:focus,#cartBtn .iconify:active{
        transform:none !important; transition:none !important; color:var(--brown) !important;
      }

      /* notif dot */
      #btnBell{ position:relative; }
      #badgeNotif.notif-dot{
        position:absolute; top:-2px; right:-3px; width:8px; height:8px; background:#4b3f36; border-radius:50%;
      ...
      /* dropdown profil */
      .dropdown-menu{
        border-radius:12px; border-color:#eee; padding:6px 0;
        font-family:"Poppins", system-ui, -apple-system, "Segoe UI", Roboto, Arial, sans-serif;
        background:#fffdf8;
      }
      .dropdown-menu .dropdown-item{
        ...
        transition:none !important; background:#fffdf8 !important;
      }
      .dropdown-menu .dropdown-item:hover,
      .dropdown-menu .dropdown-item:focus,
      .dropdown-menu .dropdown-item:active,
      .dropdown-menu .dropdown-item:focus-visible{
        background:rgba(255,213,79,.16) !important; color:var(--brown) !important;
        outline:none !important; box-shadow:none !important;
      }

      .btn-brand{
        background:var(--gold); color:var(--brown); border:0; border-radius:9999px;
        font-weight:600; padding:8px 14px; font-size:.9rem; line-height:1.2; text-decoration:none !important;
      }
      .btn-brand:hover,.btn-brand:focus{
        background:var(--gold-200); color:var(--brown);
        box-shadow:0 0 0 .16rem rgba(255,213,79,.35);
      }
      ...
      #mobileNav .nav-link{
        color:var(--brown) !important; font-weight:600; opacity:.9; padding:.6rem 0; display:flex; align-items:center; gap:.5rem;
      ...
      @media (max-width:991.98px){
        ...
        .icon-btn:hover i.bi-list,.icon-btn:active i.bi-list,.icon-btn:focus i.bi-list{
          transform:none !important; color:var(--brown) !important; opacity:1 !important;
      ...
      .search-input{
        height:46px; border-radius:9999px; padding-left:16px; padding-right:44px;
        border:1px solid #e5e7eb; outline:none !important; background:#fff; transition:border-color .1s ease;
      }
      ...
      .btn-search{
        ...
        border:0; border-radius:50%; background:transparent; color:var(--brown);
      }
      .btn-filter{
        background:var(--gold); color:var(--brown); border:0; border-radius:12px; font-weight:500;
        height:46px; width:46px; display:inline-flex; align-items:center; justify-content:center; transition:none;
      }

      /* dropdown filter */
      #filterMenu.dropdown-menu{
        border-radius:5px; border:1px solid rgba(0,0,0,.06); background:#fffef8;
        min-width:220px; max-width:320px; padding:6px 0;
        font-family:"Poppins", system-ui, -apple-system, "Segoe UI", Roboto, Arial, sans-serif;
        box-shadow:0 12px 24px rgba(0,0,0,.08); transform-origin:top right; transition:opacity .15s ease, transform .15s ease;
      }
      ...
      .card-menu,.menu-card,.product-card,.card.item,.card.product{
        width:100% !important; border-radius:18px !important; padding:12px !important; background:#fff;
        position:relative; overflow:hidden; box-shadow:0 8px 16px rgba(0,0,0,.06);
      }
      ...
      .card-menu .btn-add-to-cart,.menu-card .btn-add-to-cart,.product-card .btn-add-to-cart,.card.item .btn-add-to-cart,.card.product .btn-add-to-cart{
        position:absolute !important; right:10px !important; bottom:10px !important; width:32px !important; height:32px !important; line-height:32px !important;
        border-radius:50% !important; border:none !important; background:var(--gold) !important; color:var(--brown) !important;
        font-weight:600; font-size:1rem !important; display:inline-flex !important; align-items:center; justify-content:center;
        box-shadow:0 4px 8px rgba(0,0,0,.08); cursor:pointer;
      }
      @media (max-width:600px){
        .card-menu,.menu-card,.product-card,.card.item,.card.product{ box-shadow:0 4px 10px rgba(0,0,0,.06); }
        .card-menu .btn-add,.menu-card .btn-add,.product-card .btn-add,.card.item .btn-add,.card.product .btn-add{ width:25px !important; height:25px !important; line-height:25px !important; font-size:1rem !important; }
      }
      ...
      .btn-view{
        background-color:var(--gold); color:var(--brown) !important; border:0; border-radius:12px;
        font-family:Arial,sans-serif; font-weight:600; font-size:13.3px; line-height:1.2; padding:10px 14px;
        display:inline-flex; align-items:center; justify-content:center; gap:8px; text-decoration:none !important; box-shadow:none; cursor:pointer; white-space:nowrap;
      }
      ...
      /* ================= FOOTER ================= */
      footer{ background:var(--footer); color:var(--gold-200); padding-top:36px; padding-bottom:20px; position:relative; z-index:2; }
      ...
      .toast-mini{
        ...
        width:380px !important; max-width:calc(100vw - 32px) !important; z-index:1080 !important; border-radius:12px !important;
      }
      @media (max-width:600px){
        .toast-mini{ bottom:1rem !important; left:50% !important; right:auto !important; transform:translateX(-50%) !important;
          width:calc(100vw - 24px) !important; max-width:calc(100vw - 24px) !important; border-radius:14px !important; }
        .toast-mini .toast-body{ font-size:.8rem !important; }
      }

      /* hilangkan background di dropdown item (konsisten) */
      .dropdown-menu .dropdown-item,
      .dropdown-menu .dropdown-item:hover,
      .dropdown-menu .dropdown-item:focus,
      .dropdown-menu .dropdown-item:active{ background:transparent !important; box-shadow:none !important; outline:none !important; }

      /* Matikan panah (chevron) di link ikon kanan navbar */
      .right-actions a::before, .right-actions .icon-btn::before{ content:none !important; }

      /* ====== Hardening anti highlight/flash saat refresh/klik ====== */
      a,button,[role="button"]{ outline:none !important; box-shadow:none !important; }
      a:focus,a:active,button:focus,button:active,a:focus-visible,button:focus-visible{
        outline:none !important; box-shadow:none !important; background:transparent !important;
      }
      .icon-btn .iconify,.icon-btn i{ transform:none !important; transition:none !important; }
      /* pastikan badge cart tidak muncul sebelum JS siap */
      #cartBadge.d-none{ display:none !important; }
    </style>
  </head>
  ...
  <body>
    ...
    <nav class="navbar sticky-top shadow-sm">
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="right-actions d-flex align-items-center gap-3">
          <!-- Cart -->
          <a class="icon-btn position-relative me-lg-1" id="cartBtn" aria-label="Buka keranjang" href="/public/customer/cart.php">
            <span class="iconify" data-icon="mdi:cart-outline" data-width="24" data-height="24"></span>
            <!-- badge dikosongkan & disembunyikan -->
            <span class="badge-cart badge rounded-pill bg-danger d-none" id="cartBadge" aria-hidden="true"></span>
          </a>
          ...
          <div class="dropdown d-none d-lg-block">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow" style="min-width: 260px">
              ...
              <li><a class="dropdown-item" href="profile.php"><span class="iconify" data-icon="mdi:cog-outline"></span>Pengaturan</a></li>
              <li><a class="dropdown-item" href="faq.php"><span class="iconify" data-icon="mdi:help-circle-outline"></span>FAQ</a></li>
              <li><a class="dropdown-item" href="history.php"><span class="iconify" data-icon="mdi:receipt-text-outline"></span>Riwayat Pesanan</a></li>
              <li><hr class="dropdown-divider" /></li>
              <li><a class="dropdown-item text-danger" href="/backend/logout.php"><span class="iconify" data-icon="mdi:logout"></span>Log out</a></li>
            </ul>
          </div>
    ...
    <div class="offcanvas offcanvas-end custom-offcanvas" tabindex="-1" id="mobileNav" aria-labelledby="mobileNavLabel">
      ...
      <div class="offcanvas-body d-flex flex-column gap-2">
        ...
        <ul class="nav flex-column mt-1" id="mobileNavList">
          <li class="nav-item"><a class="nav-link" href="profile.php"><span class="iconify" data-icon="mdi:cog-outline" data-width="22" data-height="22"></span>Pengaturan</a></li>
          <li class="nav-item"><a class="nav-link" href="faq.php"><span class="iconify" data-icon="mdi:help-circle-outline" data-width="22" data-height="22"></span>FAQ</a></li>
          <li class="nav-item"><a class="nav-link" href="history.php"><span class="iconify" data-icon="mdi:receipt-text-outline" data-width="22" data-height="22"></span>Riwayat pesanan</a></li>
          <li><hr /></li>
          <li class="nav-item"><a class="nav-link text-danger" href="/backend/logout.php"><span class="iconify" data-icon="mdi:logout" data-width="22" data-height="22"></span>Log out</a></li>
        </ul>
      </div>
    </div>
    ...
    <!-- BADGE KERANJANG (bersih, tanpa '0' saat refresh) -->
  <script>
      (function () {
    ...
    <script>
      (function () {
        var PROJECT_BASE = "";                 // FIX
        var PUBLIC_BASE  = "/public";          // FIX
